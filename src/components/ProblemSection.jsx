...
const ProblemSection = () => (
  <section id="problema" className="py-24 bg-[#060610] px-6">
    <div className="max-w-7xl mx-auto">
      <div className="text-center mb-14">
        <p className="text-accent font-mono text-xs uppercase tracking-widest mb-3">O Problema</p>
        <h2 className="font-sans font-bold text-4xl md:text-5xl text-white mb-4">Quantas vendas você perdeu esse mês?</h2>
        <p className="text-light/50 text-lg max-w-2xl mx-auto">
          Cliente entrou, gostou, quis comprar... mas não tinha limite no cartão. Você ofereceu parcelamento no boleto? Antecipação de FGTS? Crédito consignado? Crédito na conta de luz?
        </p>
        <p className="text-white font-semibold text-xl mt-4">Se você não ofereceu, perdeu a venda para quem oferece.</p>
      </div>
